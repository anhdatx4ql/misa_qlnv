    ...
    <div class="notify-content" ref="notify">
      ...
      <div class="notify-content-button">
        ...
        style="justify-content: space-between;">
            <!-- button hủy -->
          <base-button class="button-white" tabindex="3" @click="$emit('checkShowNotify',false)">
            <span>Hủy</span>
          </base-button>
          <div> 
             <!-- button  -->
            <base-button class="button-white base-r-8" tabindex="2" @click="$emit('closeForm',false)">
              <span>Không</span>
            </base-button>
